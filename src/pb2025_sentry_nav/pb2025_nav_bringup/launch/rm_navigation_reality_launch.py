...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        "world",
        default_value="test05",
        description="Select reality map basename, e.g. 'test05', 'testmap_01', 'testmap_02'",
    )
    ...
    # Launch the full livox stack (driver + RVIZ + merge_cloud) via the shared launch file
