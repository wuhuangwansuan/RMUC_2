...
def generate_launch_description():
    ...
    param_substitutions = {
        ...
        "mapping_bootstrap_enabled": mapping_bootstrap_enabled,
    ...
    declare_mapping_bootstrap_enabled_cmd = DeclareLaunchArgument(
        "mapping_bootstrap_enabled",
        default_value="false",
        description="Whether to gate behavior tree execution until mapping bootstrap is finished",
    )

    declare_target_tree_cmd = DeclareLaunchArgument(
        "target_tree",
        default_value="rmul_nuc_2026",
        description="Behavior tree ID to execute on startup",
    )
    ...
    ld.add_action(declare_mapping_bootstrap_enabled_cmd)
